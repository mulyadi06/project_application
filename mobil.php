...
?>
    <!-- End of Topbar -->
                ...
                <div class="card-header">
                    ...
                    <h4 class="m-0 font-weight-bold text-dark">Data  Mobil</h4>
                </div>
                <div class="card-body">
                <table class="table">
                    <thead>
                ...
                <td>
                    <div class="btn-toolbar mb-3" role="toolbar">
                        <div class="btn-group mr-2" aria-label="First group">
                            <a href="mobil_form_edit.php?id=<?=$data['id_mobil']?>">
                        ...
                        <div>
                            <a href="mobil_proses_hapus.php?id=<?=$data['id_mobil']?>" onclick="return confirm('Apakah Data <?=$data['no_pol']?> Ingin Dihapus?')">
