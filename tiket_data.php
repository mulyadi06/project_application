    ...
    <div id="wrapper">
        ...
        ?>
                ...
                <div class="card-header">
                    <h4 class="m-0 font-weight-bold text-dark">Data Pemesanan</h4>
                </div>
                <div class="card-body">
                <table class="table">
                    <thead>
                ...
                $sql = "SELECT * FROM tb_transaksi INNER JOIN tb_mobil ON tb_transaksi.id_mobil=tb_mobil.id_mobil WHERE confirmed=1";
                ...
                <tr>
                    ...
                    <div class="btn-toolbar mb-2" role="toolbar">
                        ...
                        <div>
                            <a href="tiket_proses_hapus.php?id=<?=$data['no_transaksi']?>" onclick="return confirm('Apakah Data <?=$data['nm_pemesan']?> Ingin Dihapus?')">
