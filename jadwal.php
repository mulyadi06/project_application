    ...
    <div id="wrapper">
        ...
        ?>
                ...
                <a href="jadwal_form_tambah.php" >
                    ...
                    <h4 class="m-0 font-weight-bold text-dark">Jadwal Berangkat</h4>
                </div>
                <div class="card-body">
                <table class="table">
                    <thead>
                ...
                <td>
                    <div class="btn-toolbar mb-3" role="toolbar">
                        <div class="btn-group mr-2" aria-label="First group">
                            <a href="jadwal_form_edit.php?id=<?=$data['id_jadwal']?>">
                        ...
                        <div>
                            <a href="jadwal_proses_hapus.php?id=<?=$data['id_jadwal']?>" onclick="return confirm('Apakah Data <?=$data['no_pol']?> Ingin Dihapus?')">
