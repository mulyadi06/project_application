    ...
    <div id="wrapper">
        ...
        ?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
 <form action="pembayaran_proses_tambah.php" method="POST">
    <div class="mb-3">
    ...
    <input type="text" name="total_bayar" class="form-control" id="exampleInputPassword1">
  </div>
  <button type="submit" class="btn btn-success btn-round px-4 btn-sm ">Bayar</button>
     <a href="pembayaran.php" class="btn btn-danger btn-round px-5 btn-sm">Batal</a>
</form>
