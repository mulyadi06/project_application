    ...
    <div id="wrapper">
        ...
        ?>
                ...
                <div class="card-header">
                    ...
                    <h4 class="m-0 font-weight-bold text-dark">Data Supir</h4>
                </div>
                <div class="card-body">
                <table class="table">
                    <thead>
                ...
                <tr>
                    ...
                    <td><?=$data['alamat']?></td>
                    <td><?=$data['hp_supir1']?></td>
                    <td><?=$data['foto_supir1']?></td>
                <td>
                    <div class="btn-toolbar mb-3" role="toolbar">
                        <div class="btn-group mr-2" aria-label="First group">
                            <a href="supir_form_edit.php?id=<?=$data['id_supir1']?>">
                        ...
                        <div>
                            <a href="supir_proses_hapus.php?id=<?=$data['id_supir1']?>" onclick="return confirm('Apakah Data <?=$data['nm_supir1']?> Ingin Dihapus?')">
