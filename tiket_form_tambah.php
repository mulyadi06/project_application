...
<body id="page-top">
 ...
 <form action="tiket_proses_tambah.php" method="POST">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="bangku" class="form-control" id="exampleInputPassword1">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Jam Berangkat</label>
  ...
  <button type="submit" class="btn btn-success btn-round px-4 btn-sm ">Pesan Tiket</button>
     <a href="tiket.php" class="btn btn-danger btn-round px-5 btn-sm">Batal</a>
</form>
