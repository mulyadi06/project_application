...
?>
    <!-- End of Topbar -->
                ...
                <div class="card-header">
                    ...
                    <h4 class="m-0 font-weight-bold text-dark">Daftar Jurusan</h4>
                </div>
                <div class="card-body">
                ...
                <td>
                    <div class="btn-toolbar mb-3" role="toolbar">
                        ...
                        <div>
                            <a href="tujuan_proses_hapus.php?id=<?=$data['id_tujuan']?>" onclick="return confirm('Apakah Data <?=$data['dari_tujuan']?> Ingin Dihapus?')">
